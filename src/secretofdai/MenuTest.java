...
*/
public class MenuTest extends juego
    implements ActionListener
{
    ...
    public void init() {
        ...
        JFrame frame = super.pantalla.getFullScreenWindow();
    ...
    */
    public JButton createButton(String name, String toolTip) {
        ...
        Image image = pantalla.createCompatibleImage(w, h,
        ...
        image = pantalla.createCompatibleImage(w, h,
            Transparency.TRANSLUCENT);
